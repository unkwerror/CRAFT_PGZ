...
class Settings(BaseSettings):
    ...
    # Sonnet 5: дешевле Opus (~в 1.7 раза вход/выход) и кэширует системный промпт
    # (мин. префикс 1024 ток. против 4096 у Opus). На объёме 1000+ карточек — заметная
    # экономия. Минус: склонен завышать баллы на пограничных — держим порог relevant повыше.
